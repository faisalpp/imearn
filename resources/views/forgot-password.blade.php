                ...
                <div class="accounts-left">
                    <div class="accounts-left-content">
                        <div class="section-header">
                            ...
                            <h3 class="section-header__title">IM EasyCash Forgot Password</h3>
                            <p>
                                Turn Your ideas into Reality
                            </p>
                        </div>
                        <form class="row gy-4" id="loginfor" action="{{url('/forgot-password')}}" method="post">
                            ...
                            <div class="col-sm-12">
                                <button type="submit" class="cmn--btn">Submit<div class="spinner-borde"></div></button>
                            </div>
                        </form>
                    </div>
                </div>
