...
<div class="dashboard--content-item">
    ...
    <div class="profile--card">
      <div class="user--profile mb-5">
          <div class="d-flex  justify-content-center thumb">
          ...
          <div class="content">
              ...
              <form id="img-frm" class="mt-4" action="{{url('/user/profile-image/update')}}" method="post" enctype="multipart/form-data" >
                @csrf  
          ...
          <form class="row gy-4" action="{{url('/user/profile-update')}}" method="post">
            @csrf
              ...
              <div class="col-sm-6 col-xxl-4">
                  ...
                  <input type="text" name="wallet_address" class="form-control" value="{{$user->profile->wallet_address}}">
              </div>
              ...
              <div class="col-sm-6 col-xxl-4">
                ...
                <input type="text" id="address"  name="address" class="form-control" value="{{$user->profile->address}}">
              </div>
