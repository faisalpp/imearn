...
@section('main')
@push('title')
<title>Manage Gateway</title>
@endpush
<div class="dashborad--content">
				<div class="breadcrumb-area">
  <h3 class="title">Manage Gateway</h3>
  <ul class="breadcrumb">
      <li>
        <a href="{{url('/admin/dashboard')}}">Dashboard</a>
      </li>

      <li>Manage Gateway</li>
  </ul>
</div>
    ...
    <div class="table-responsive table--mobile-lg">
        <table class="table bg--body mt-2">
            ...
            <tbody>
              ...
              <form action="{{url('/admin/update-gateway')}}" method="post" >
                @csrf
              ...
              <tr>
               ...
               <td data-label="Date">
                ...
                <a href="{{url('/admin/delete-gateway')}}/{{$gateway->id}}" ><button type="button" class="cmn--btn" style="background-color:red !important;height:35px !important" >Delete</button></a>
               </td>
