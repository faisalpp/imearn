...
<div class="dashborad--content">
  ...
  <h3 class="title">Extend Memberships</h3>
  <ul class="breadcrumb">
      <li>
        <a href="{{url('/admin/dashboard')}}">Dashboard</a>
      </li>

      <li>Extend Memberships</li>
  </ul>
</div>
...
<script>
    function ApproveMembership(id,index){
      ...
      const url = `{{url('/admin/approve-extend-membership')}}/${id}`
...
<div class="d-flex justify-content-end" >
  <div class="d-flex align-items-center bg-white mb-2 px-2 py-2 rounded" style="border:1px solid red;" >
    ...
    <a href="{{url('/admin/extend-memberships/approved')}}" ><button type="button" style="font-size:12px;border:none;background-color:#9A2441 !important;" class="btn btn-danger proof-button" >Approved</button></a>
    <a href="{{url('/admin/extend-memberships/pending')}}" ><button type="button" style="font-size:12px;border:none;background-color:#9A2441 !important;" class="btn btn-danger proof-button mx-2" >Pending</button></a>
    <a href="{{url('/admin/extend-memberships/rejected')}}" ><button type="button" style="font-size:12px;border:none;background-color:#9A2441 !important;" class="btn btn-danger proof-button mx-2" >Rejected</button></a>
    <a href="{{url('/admin/extend-memberships/all')}}" ><button type="button" style="font-size:12px;border:none;background-color:#9A2441 !important;" class="btn btn-danger proof-button" >All</button></a>
  </div>
</div>
        ...
        <table class="table bg--body">
            ...
            <tbody>
              ...
              <tr>
               ...
               <td data-label="Date"><div>{{$membership->amount / 100}}</div></td>
              ...
              <span id="membership_loader{{$loop->index}}" style="display:none;justify-content:center;align-items:center;width:25px;height:25px;background-color:rgb(164, 247, 164);border-radius:100%;" class="mx-2">
                ...
                <!-- Button trigger modal -->
                <button type="button" style="display:flex;justify-content:center;border:none;align-items:center;width:25px;height:25px;background-color:rgb(250, 148, 148);border-radius:100%;" data-bs-toggle="modal" data-bs-target="#exampleModalRejectMembership">
                <i class="fa fa-ban" style="color: red;cursor: pointer;" ></i>
                </button>
                <!-- Modal -->
                <div class="modal fade" id="exampleModalRejectMembership" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                 <div class="modal-dialog">
                  <div class="modal-content">
                   <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">
                   ...
                   <form class="row gy-4 px-3" action="{{url('/admin/reject-extend-membership')}}" method="post">
                   @csrf
                   <div class="pt-3 pb-2">
